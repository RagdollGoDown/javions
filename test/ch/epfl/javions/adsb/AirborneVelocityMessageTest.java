...
class AirborneVelocityMessageTest {
    private final String values = "AirborneVelocityMessage[timeStampNs=100775400, icaoAddress=IcaoAddress[string=39D300], speed=217.1759987875795, trackOrHeading=5.707008696317668]\n" +
    ...
    @Test
    void testMessage(){
        String message2 = "8D485020994409940838175B284F";
        int time2 = 1499146900;
        RawMessage rawMessage2 = new RawMessage(time2, ByteString.ofHexadecimalString(message2));
        AirborneVelocityMessage a2 = AirborneVelocityMessage.of(rawMessage2);
        System.out.println(a2);
        System.out.println(Units.convert(a2.speed(),Units.Speed.METER_PER_SECOND,Units.Speed.KNOT));
        String message = "8DA05F219B06B6AF189400CBC33F";
        int time = 1499146900;
        RawMessage rawMessage = new RawMessage(time, ByteString.ofHexadecimalString(message));
        AirborneVelocityMessage a = AirborneVelocityMessage.of(rawMessage);
        assertEquals(Units.convert(a.speed(),Units.Speed.METER_PER_SECOND,Units.Speed.KNOT),375,0.01);
        assertEquals(Units.convert(a.trackOrHeading(),Units.Angle.RADIAN,Units.Angle.DEGREE),243.98,0.01);
    }
}